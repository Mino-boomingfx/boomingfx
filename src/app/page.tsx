  ...
  return (
    <div className="bg-white overflow-hidden selection:bg-[#004185] selection:text-white">
      ...
      */}
      ...
      {/* 
        ========================================================================
        COMMUNITY IN ACTION - LIVE IN-OFFICE SLIDESHOW
        ========================================================================
      */}
      <section className="py-24 bg-[#001733] text-white relative overflow-hidden">
        {/* Glowing Orbs */}
        <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-[#004185] rounded-full filter blur-[160px] opacity-40 pointer-events-none"></div>
        <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-cyan-500 rounded-full filter blur-[150px] opacity-20 pointer-events-none"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-400/10 border border-cyan-400/30 text-cyan-300 text-xs font-black uppercase tracking-widest mb-4">
                <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
                <span>Community In Action</span>
              </div>
              <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter leading-tight">
                Downtown Edmonton <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Office &amp; Mentorship</span>
              </h2>
            </div>
            <div className="flex flex-col items-start md:items-end gap-4">
              <p className="text-blue-100/70 text-base max-w-md md:text-right">
                Real traders. Real physical offices. Real continuous mentorship in Edmonton and across North America.
              </p>
              <a 
                href="/media" 
                className="inline-flex items-center gap-2 text-cyan-300 hover:text-white font-bold text-sm bg-white/10 hover:bg-white/15 px-5 py-2.5 rounded-full border border-white/10 transition-all transform hover:scale-105"
              >
                View Full Photo Archive (15 Photos)
          ...
          <MediaSlideshow photos={(content.media as any)?.gallery || (defaultContent.media as any).gallery || []} autoPlayInterval={4500} showThumbnails={true} />
        </div>
      </section>
