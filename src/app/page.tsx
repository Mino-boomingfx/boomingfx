  ...
  return (
    <div className="bg-white overflow-hidden selection:bg-[#004185] selection:text-white">
      ...
      */}
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-6 items-center justify-center w-full">
            ...
            >
              ...
              <svg className="w-5 h-5 transform group-hover:translate-y-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
            </a>
          </div>

          {/* Social Proof / Trust Indicators */}
          <div className="mt-20 flex flex-col sm:flex-row items-center justify-center gap-8 text-white/70 backdrop-blur-sm bg-black/20 py-4 px-10 rounded-full border border-white/10">
            <div className="flex items-center gap-2">
              <div className="flex -space-x-3">
                {[1,2,3,4].map((i) => (
                  <div key={i} className={`w-10 h-10 rounded-full bg-gradient-to-br from-white to-gray-400 border-2 border-[#004185] flex items-center justify-center text-black font-bold text-xs`}>
                    User
                  </div>
                ))}
              </div>
              <span className="ml-4 font-semibold text-white">500+ Active Traders</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-white/20"></div>
            <div className="flex items-center gap-3 cursor-pointer group">
              <img src="http://boomingfx.local/wp-content/uploads/2025/08/google-5-star-reviews.webp" alt="Google 5 Star Reviews" className="h-8 group-hover:scale-110 transition-transform duration-300" />
      ...
      {/* 
        ========================================================================
        MARKET TICKER (Pro styling)
        ========================================================================
      */}
      <section className="bg-black py-4 border-b border-gray-900 relative z-20">
        <div className="max-w-7xl mx-auto px-4 overflow-hidden">
          <div className="flex items-center justify-between text-sm font-bold text-white/60">
             <span className="flex items-center gap-3 hover:text-white transition-colors cursor-default"><span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span> S&P 500 <span className="text-white">5,123.41</span> <span className="text-red-500 bg-red-500/10 px-2 py-0.5 rounded">-0.24%</span></span>
             <span className="flex items-center gap-3 hover:text-white transition-colors cursor-default"><span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span> NASDAQ <span className="text-white">16,211.90</span> <span className="text-green-500 bg-green-500/10 px-2 py-0.5 rounded">+1.12%</span></span>
             <span className="flex items-center gap-3 hover:text-white transition-colors cursor-default"><span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span> EUR/USD <span className="text-white">1.0842</span> <span className="text-red-500 bg-red-500/10 px-2 py-0.5 rounded">-0.02%</span></span>
             <span className="hidden md:flex items-center gap-3 hover:text-white transition-colors cursor-default"><span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span> BTC/USD <span className="text-white">64,231.00</span> <span className="text-green-500 bg-green-500/10 px-2 py-0.5 rounded">+4.51%</span></span>
          </div>
        </div>
      </section>
            ...
            {/* Small Card 3 */}
             <div className="group relative bg-[#004185] rounded-[2rem] p-10 overflow-hidden transform hover:-translate-y-2 transition-all duration-500 shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/80 font-medium">24/7 access to all trading courses the second you enroll.</p>
              </div>
            </div>
