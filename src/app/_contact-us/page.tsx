            ...
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="group flex items-start gap-6 p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 hover:border-blue-500/30 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/80 font-medium">
                      10665 Jasper Ave, 14th floor<br/>
                ...
                <div className="group flex items-start gap-6 p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 hover:border-purple-500/30 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/80 font-medium">
                      <span className="text-purple-400 font-bold">8 AM - 8 PM</span> (Mon-Fri)
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all duration-300 shadow-[0_0_0_rgba(24,119,242,0)] hover:shadow-[0_0_20px_rgba(24,119,242,0.4)] hover:-translate-y-1">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
                  </a>
                  <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] transition-all duration-300 shadow-[0_0_0_rgba(255,0,0,0)] hover:shadow-[0_0_20px_rgba(255,0,0,0.4)] hover:-translate-y-1">
                  ...
                  <a href="#" className="group relative w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 overflow-hidden transition-all duration-300 hover:border-transparent hover:text-white hover:shadow-[0_0_20px_rgba(220,39,67,0.4)] hover:-translate-y-1">
